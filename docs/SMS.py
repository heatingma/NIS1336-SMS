...
class SM():
    ...
    def team_init(self):
        ...
        self.team_box = textBox(250,190,500,200,font=18,color=self.screen_color,font_color='black',x_format='left',y_format='up')
    ...
    def help_action(self):
        while(True):
            ...
            if self.home_button.active:
                ...
                self.exit()
            self.update_screen([self.title,self.home_button,self.help_box,self.exit_button]) 
